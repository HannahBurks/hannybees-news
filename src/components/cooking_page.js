    ...
    export default function Cooking(){
        const [articleDataCooking, setArticleDataCooking] = useState([])
    ...
    return (
        <div className ="cookingitemCard">
            <h2 className="cookingHeading">Cooking Articles</h2>
             {articleDataCooking.map((article) => {
                return (
